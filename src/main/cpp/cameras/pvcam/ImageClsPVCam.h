...
public:
    ...
    // timer
    double timeelapsed1; // ms // total time elapse from start - end including
                         // JNI transfer
    ...
    int32 ExpResMode_ =
        EXP_RES_ONE_MILLISEC; // atuomatically set to EXP_RES_ONE_MILLISEC,
                              // EXP_RES_ONE_MICROSEC, EXP_RES_ONE_SEC
    ...
    int32 PMode_; // If this is a Frame Transfer sensor set PARAM_PMODE to
                  // PMODE_FT. If not a Frame Transfer sensor (i.e. Interline),
                  // set PARAM_PMODE to PMODE_NORMAL, or PMODE_ALT_NORMAL.
    int16 bitDepth_;
    uns16 pixTime_;
