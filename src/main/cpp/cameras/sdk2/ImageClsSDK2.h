...
public:
    ...
    void setPixelDimParam(int hstart, int hend, int vstart, int vend,
                          int incamerabin); // s
    ...
    int iAD; // index of AD used throughout; get called during camera
             // initialization//0
...
public:
    ...
    int sum_pixel; // sum of counts in all pixel of problematic frame
                   // (supposedly zero)
    int noframe;
...
public:
    ...
    void sumpixelcount(int framesize, long *ptr, int i, int frameInterval,
                       int j)
    {
