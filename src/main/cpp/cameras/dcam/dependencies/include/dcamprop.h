...
#    endif
    ...
    {
        /*** direction flag for dcam_getnextpropertyid(),
    ...
    typedef enum _DCAMPROPATTRIBUTE
    {
        ...
        DCAMPROP_ATTR_AUTOROUNDING =
            0x00800000, /* The dcam_setproperty() or dcam_setgetproperty() will
                           failure if this bit exists. */
        /* If this flag does not exist, the value will be round up when it is
           not supported. */
        DCAMPROP_ATTR_STEPPING_INCONSISTENT = 0x00400000,
        /* The valuestep of DCAM_PROPERTYATTR is not consistent across the
           entire range of	*/
        /* values.
         */
        ...
        /* application has to use double-float type variable even the property
           is not REAL.	*/
    ...
    typedef enum _DCAMPROPMODEVALUE
    {
        ...
        /* DCAM_IDPROP_OUTPUTTRIGGER_CHANNELSYNC */ /* numeric headletter
                                                       options */
