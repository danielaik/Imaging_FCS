...
extern "C"
{
    ...
    typedef int(AT_EXP_CONV *FeatureCallback)(AT_H Hndl, const AT_WC *Feature,
                                              void *Context);
    int AT_EXP_CONV AT_RegisterFeatureCallback(AT_H Hndl, const AT_WC *Feature,
                                               FeatureCallback EvCallback,
                                               void *Context);
    ...
    int AT_EXP_CONV AT_SetEnumerated(AT_H Hndl, const AT_WC *Feature,
                                     int Value);
    int AT_EXP_CONV AT_SetEnumeratedString(AT_H Hndl, const AT_WC *Feature,
                                           const AT_WC *String);
    int AT_EXP_CONV AT_GetEnumerated(AT_H Hndl, const AT_WC *Feature,
                                     int *Value);
    int AT_EXP_CONV AT_GetEnumeratedCount(AT_H Hndl, const AT_WC *Feature,
                                          int *Count);
    ...
    int AT_EXP_CONV AT_IsEnumeratedIndexImplemented(AT_H Hndl,
                                                    ...
                                                    int Index,
                                                    AT_BOOL *Implemented);
    int AT_EXP_CONV AT_GetEnumeratedString(AT_H Hndl, const AT_WC *Feature,
                                           int Index, AT_WC *String,
                                           int StringLength);
    ...
    int AT_EXP_CONV AT_GetEnumCount(AT_H Hndl, const AT_WC *Feature,
                                    int *Count);
    int AT_EXP_CONV AT_IsEnumIndexAvailable(AT_H Hndl, const AT_WC *Feature,
                                            int Index, AT_BOOL *Available);
    int AT_EXP_CONV AT_IsEnumIndexImplemented(AT_H Hndl, const AT_WC *Feature,
                                              int Index, AT_BOOL *Implemented);
    int AT_EXP_CONV AT_GetEnumStringByIndex(AT_H Hndl, const AT_WC *Feature,
                                            int Index, AT_WC *String,
                                            int StringLength);
    ...
    int AT_EXP_CONV AT_SetString(AT_H Hndl, const AT_WC *Feature,
                                 const AT_WC *String);
    int AT_EXP_CONV AT_GetString(AT_H Hndl, const AT_WC *Feature, AT_WC *String,
                                 int StringLength);
    int AT_EXP_CONV AT_GetStringMaxLength(AT_H Hndl, const AT_WC *Feature,
                                          int *MaxStringLength);
