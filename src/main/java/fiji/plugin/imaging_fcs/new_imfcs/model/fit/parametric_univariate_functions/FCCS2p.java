...
/**
 * The FCCS_2p class represents a specific parametric univariate function for fitting
 ...
 */
public class FCCS_2p extends FCSFit {
    /**
     * Constructs a new FCCS_2p instance with the given settings and fit model.
     *
     * @param settings The experimental settings model.
     * @param fitModel The fit model.
     */
    public FCCS_2p(ExpSettingsModel settings, FitModel fitModel) {
