...
public class FitResult {
    ...
    public void isCompatible(int numberFits, int numberParameters) {
        GpufitUtils.assertTrue(parameters.capacity() == numberFits * numberParameters,
                "Expected different size of parameters");
        ...
        GpufitUtils.assertTrue(numberIterations.capacity() == numberFits,
                "Expected different size of numberIterations");
    }
}
