...
import fiji.plugin.imaging_fcs.imfcs.model.fit.parametric_univariate_functions.FCSFit;
...
public class GpuFitter {
    ...
    private final fiji.plugin.imaging_fcs.imfcs.model.FitModel fitModel;
     ...
     */
    public GpuFitter(GpuParameters gpuParams, fiji.plugin.imaging_fcs.imfcs.model.FitModel fitModel,
