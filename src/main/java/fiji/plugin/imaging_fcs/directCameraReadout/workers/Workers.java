package fiji.plugin.imaging_fcs.directCameraReadout.workers;
...
import static fiji.plugin.imaging_fcs.directCameraReadout.gui.DirectCapturePanel.Common.selected_livevideo_binningMode;
import static fiji.plugin.imaging_fcs.directCameraReadout.gui.DirectCapturePanel.DisplayImageObj;
import static fiji.plugin.imaging_fcs.directCameraReadout.gui.DirectCapturePanel.CCFselectorChecker;

import static fiji.plugin.imaging_fcs.directCameraReadout.gui.DirectCapturePanel.iccsObj1;
import fiji.plugin.imaging_fcs.directCameraReadout.gui.parameterName;
    ...
    public static class LiveVideoWorkerV2 extends SwingWorker<Void, Void> {
        ...
        MouseListener impcanLiveMouseUsed = new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (Common.isCCFmode) {
                    isCCFselectionOK = CCFselectorChecker(Common.oWidth, Common.oHeight, Common.CCFdistX, Common.CCFdistY, Common.BinXSoft, Common.BinYSoft, Common.lLeft - 1, Common.lTop - 1, Common.lWidth, Common.lHeight);
                    if (!isCCFselectionOK) {
